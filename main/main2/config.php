...
return [
    'modules' => [
        ...
        'FishPig_WordPress' => 1,
        'Advanblack_CategoryPages' => 1,
        'Advanblack_CollectCodeMagna' => 1,
        'Advanblack_ColorGroup' => 1,
        'Advanblack_Configurations' => 1,
        'Advanblack_DealerLocator' => 1,
        'Advanblack_FitMyBike' => 1,
        'Advanblack_ImportExport' => 1,
        'Advanblack_InStock' => 1,
        'Advanblack_Migration' => 1,
        'Advanblack_Navigation' => 1,
        'Advanblack_PopularUpgrades' => 1,
        'Advanblack_ShopByColor' => 1,
        'Amasty_Base' => 1,
        'Alwayly_SyncTongTool' => 1,
        'Amasty_ShopbyBase' => 1,
        'Amasty_Conditions' => 1,
